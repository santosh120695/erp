...
class RawMaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create raw_material" do
    assert_difference('RawMaterial.count') do
      post raw_materials_url, params: { raw_material: { material_type: @raw_material.material_type, name: @raw_material.name } }
    end
  ...
  test "should update raw_material" do
    patch raw_material_url(@raw_material), params: { raw_material: { material_type: @raw_material.material_type, name: @raw_material.name } }
