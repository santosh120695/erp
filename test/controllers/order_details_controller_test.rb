...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post order_details_url, params: { order_detail: { amount: @order_detail.amount, discount_percentage: @order_detail.discount_percentage, pi_id: @order_detail.pi_id, product_id: @order_detail.product_id, quantity: @order_detail.quantity, rate: @order_detail.rate, status: @order_detail.status, tax: @order_detail.tax, total_amount: @order_detail.total_amount } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { amount: @order_detail.amount, discount_percentage: @order_detail.discount_percentage, pi_id: @order_detail.pi_id, product_id: @order_detail.product_id, quantity: @order_detail.quantity, rate: @order_detail.rate, status: @order_detail.status, tax: @order_detail.tax, total_amount: @order_detail.total_amount } }
